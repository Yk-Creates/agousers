...
const RequestHistory = ({navigation}: any) => {
  const {data, isLoading, error, refetch} = useGetRequestHistory();
  ...
  const renderItem = ({item}) => (
    <View style={styles.card}>
      <View style={styles.cardHeader}>
        <Text style={styles.cardTitle}>Past Ride </Text>
        {item.driver && (
          <TouchableOpacity
            onPress={() =>
  ...
  return (
    <>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Past Bookings</Text>
      </View>
      <View style={styles.container}>
        <FlatList
